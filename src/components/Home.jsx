...
const Home = () => {
  return (
    <div className=" min-h-screen flex flex-row justify-between items-center lg:px-32 px-5 bg-[url('./assets/img/heroo.webp')] bg-cover bg-no-repeat ">
      <div className=" w-full lg:w-2/3 space-y-5">
        ...
        <div className="justify-start items-start lg:pl-44">
